...
var x = new CountDown(parseInt(pomodoroTime));
...
var y = new CountDown(parseInt(breakTime));
...
var numberPomodoros = parseInt(document.getElementById("number-pomodoros").value);
document.getElementById("number-pomodoros").addEventListener('touchend', function() {
	numberPomodoros = parseInt(document.getElementById("number-pomodoros").value);
}, false);
...
function show() {
	$time = document.getElementById('title');
	update();
}

function update() {
	$time.innerHTML = convertTime(x.time());
}
